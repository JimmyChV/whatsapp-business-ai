...
export const PERMISSION_TENANT_USERS_READ = 'tenant.users.read';
...
export const PERMISSION_TENANT_ZONES_READ = 'tenant.zones.read';
export const PERMISSION_TENANT_ZONES_MANAGE = 'tenant.zones.manage';
export const PERMISSION_TENANT_AI_READ = 'tenant.ai.read';
export const PERMISSION_TENANT_AI_MANAGE = 'tenant.ai.manage';
export const PERMISSION_TENANT_COMMERCIAL_INTELLIGENCE_READ = 'tenant.commercial_intelligence.read';
export const PERMISSION_TENANT_COMMERCIAL_INTELLIGENCE_MANAGE = 'tenant.commercial_intelligence.manage';
...
export const PERMISSION_TENANT_CATALOGS_READ = 'tenant.catalogs.read';
export const PERMISSION_TENANT_CATALOGS_MANAGE = 'tenant.catalogs.manage';
export const PERMISSION_TENANT_CAMPAIGNS_READ = 'tenant.campaigns.read';
export const PERMISSION_TENANT_CAMPAIGNS_MANAGE = 'tenant.campaigns.manage';
export const PERMISSION_TENANT_META_ADS_READ = 'tenant.meta_ads.read';
export const PERMISSION_TENANT_META_ADS_MANAGE = 'tenant.meta_ads.manage';
export const PERMISSION_TENANT_META_TEMPLATES_READ = 'tenant.meta_templates.read';
export const PERMISSION_TENANT_META_TEMPLATES_MANAGE = 'tenant.meta_templates.manage';
export const PERMISSION_TENANT_AUTOMATIONS_READ = 'tenant.automations.read';
export const PERMISSION_TENANT_AUTOMATIONS_MANAGE = 'tenant.automations.manage';
export const PERMISSION_TENANT_SCHEDULES_READ = 'tenant.schedules.read';
export const PERMISSION_TENANT_SCHEDULES_MANAGE = 'tenant.schedules.manage';
export const PERMISSION_TENANT_AUDIT_READ = 'tenant.audit.read';
export const PERMISSION_TENANT_EMAIL_TEMPLATES_READ = 'tenant.email_templates.read';
export const PERMISSION_TENANT_EMAIL_TEMPLATES_MANAGE = 'tenant.email_templates.manage';
export const PERMISSION_TENANT_BRAND_READ = 'tenant.brand.read';
export const PERMISSION_TENANT_BRAND_MANAGE = 'tenant.brand.manage';
export const PERMISSION_TENANT_PROFILE_MANAGE = 'tenant.profile.manage';
export const PERMISSION_TENANT_CHAT_OPERATE = 'tenant.chat.operate';
export const PERMISSION_TENANT_CHAT_ASSIGN_AUTONOMOUS = 'tenant.chat.assign_autonomous';
