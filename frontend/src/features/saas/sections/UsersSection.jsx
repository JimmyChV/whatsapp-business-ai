...
const PERMISSION_GROUPS = Object.freeze([
    ...
    },
    {
        id: 'settings',
        title: 'CONFIGURACION',
        permissions: ['tenant.settings.read', 'tenant.settings.manage', 'tenant.integrations.read', 'tenant.integrations.manage', 'tenant.assets.upload', 'tenant.users.read', 'tenant.users.manage', 'tenant.users.owner.assign', 'tenant.overview.read']
    }
]);

const SENSITIVE_SELLER_PERMISSIONS = new Set(['tenant.modules.manage', 'tenant.settings.manage', 'tenant.integrations.manage', 'tenant.users.manage']);
