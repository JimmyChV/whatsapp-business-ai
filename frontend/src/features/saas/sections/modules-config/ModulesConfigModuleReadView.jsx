        ...
        <>
            <div className="saas-admin-hero">
                <div className="saas-admin-hero-media">
                    {moduleInDetail.imageUrl
                        ? <img src={moduleInDetail.imageUrl} alt={moduleInDetail.name || 'Módulo'} className="saas-admin-hero-image" />
                ...
                <div className="saas-admin-hero-content">
                    <h4>{moduleInDetail.name || 'Módulo sin nombre'}</h4>
                    <p>{moduleInDetail.phoneNumber || 'Sin número vinculado'}</p>
                </div>
            </div>
            <div className="saas-admin-detail-grid">
                <div className="saas-admin-detail-field"><span>CÓDIGO</span><strong>{moduleInDetail.moduleId || '-'}</strong></div>
                <div className="saas-admin-detail-field"><span>Transporte</span><strong>Cloud API</strong></div>
                <div className="saas-admin-detail-field"><span>TELÉFONO</span><strong>{moduleInDetail.phoneNumber || 'Sin número'}</strong></div>
                ...
                <div className="saas-admin-detail-field"><span>CATÁLOGOS ASIGNADOS</span><strong>{moduleCatalogLabels.length}</strong></div>
            ...
            {moduleInDetail.imageUrl && (
                <div className="saas-admin-preview-strip">
                    <img src={moduleInDetail.imageUrl} alt={moduleInDetail.name || 'Módulo'} className="saas-admin-preview-thumb" />
                </div>
            )}

            <div className="saas-admin-related-block">
                <h4>USUARIOS DEL MÓDULO</h4>
            ...
            <div className="saas-admin-related-block">
                <h4>CATÁLOGOS DEL MÓDULO</h4>
                <div className="saas-admin-related-list">
                    {moduleCatalogLabels.length === 0 && <div className="saas-admin-empty-inline">Sin catálogos asignados.</div>}
            ...
            <div className="saas-admin-related-block">
                <h4>CONFIGURACIÓN META CLOUD</h4>
                <div className="saas-admin-detail-grid">
