...
import { loadCachedGlobalLabels, loadCachedSaasUiPreference, loadCachedTenantZoneRules } from '../../../services';
...
export default function useSaasPanelActionContexts(input = {}) {
    ...
    const panelNavigation = useSaasPanelNavigation({
        ...
        canViewCatalog: c.canViewCatalog,
    ...
    const operationAccess = useSaasOperationAccess({
        ...
        canOperateChat: c.canOperateChat,
    ...
    const lifecycleState = useSaasPanelLifecycle({
        bootstrap: {
            actions: {
                ...
                loadAutomations: c.canViewAutomations ? c.loadAutomations : null,
            ...
            loadEffects: {
                ...
                canViewSuperAdminSections: c.canViewSuperAdminSections,
                canViewAccessCatalog: c.canViewUsers || c.canManageRoles,
                canViewTenantSettings: c.canViewTenantSettings,
                canViewModules: c.canViewModules,
                canViewCatalog: c.canViewCatalog,
                canViewAi: c.canViewAi,
                ...
                loadMetaTemplates: c.canViewMetaTemplates ? c.loadMetaTemplates : null,
                loadCampaigns: c.canViewCampaigns ? c.loadCampaigns : null,
                loadAutomations: c.canViewAutomations ? c.loadAutomations : null,
                loadSchedules: c.canViewSchedules ? c.loadSchedules : null,
                loadQuickReplyData: quickReplyAdminActions.loadQuickReplyData,
                loadTenantLabels: tenantLabelsAdminActions.loadTenantLabels,
                loadColumnPrefsForSection: (sectionKey) => loadCachedSaasUiPreference(c.requestJson, sectionKey),
