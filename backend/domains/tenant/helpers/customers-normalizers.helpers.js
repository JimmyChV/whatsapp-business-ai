...
function sanitizePublic(item = {}) {
    ...
    return {
        ...
        erpEmployeeId: toText(source.erpEmployeeId || source.erp_employee_id) || null,
        referralCustomerId: toText(source.referralCustomerId || source.referral_customer_id) || null,
        marketingOptInStatus: toText(source.marketingOptInStatus || source.marketing_opt_in_status) || null,
        phoneStatus: toText(source.phoneStatus || source.phone_status) || 'unknown',
        phone_status: toText(source.phoneStatus || source.phone_status) || 'unknown',
        phoneStatusCheckedAt: toIsoText(source.phoneStatusCheckedAt || source.phone_status_checked_at || '') || null,
        phone_status_checked_at: toIsoText(source.phoneStatusCheckedAt || source.phone_status_checked_at || '') || null,
        phoneStatusErrorCode: source.phoneStatusErrorCode ?? source.phone_status_error_code ?? null,
        phone_status_error_code: source.phoneStatusErrorCode ?? source.phone_status_error_code ?? null,
        diasUltimaCompra: source.diasUltimaCompra ?? source.dias_ultima_compra ?? null,
        dias_ultima_compra: source.diasUltimaCompra ?? source.dias_ultima_compra ?? null,
        ultimoPedidoId: toText(source.ultimoPedidoId || source.ultimo_pedido_id) || null,
        ultimo_pedido_id: toText(source.ultimoPedidoId || source.ultimo_pedido_id) || null,
        ultimaFechaCompra: toText(source.ultimaFechaCompra || source.ultima_fecha_compra) || null,
        ultima_fecha_compra: toText(source.ultimaFechaCompra || source.ultima_fecha_compra) || null,
        primeraFechaCompra: toText(source.primeraFechaCompra || source.primera_fecha_compra) || null,
        primera_fecha_compra: toText(source.primeraFechaCompra || source.primera_fecha_compra) || null,
        primerPedidoId: toText(source.primerPedidoId || source.primer_pedido_id) || null,
        primer_pedido_id: toText(source.primerPedidoId || source.primer_pedido_id) || null,
        comprasTotal: source.comprasTotal ?? source.compras_total ?? null,
        compras_total: source.comprasTotal ?? source.compras_total ?? null,
        compras120: source.compras120 ?? source.compras_120 ?? null,
        compras_120: source.compras120 ?? source.compras_120 ?? null,
        monto120: source.monto120 ?? source.monto_120 ?? null,
        monto_120: source.monto120 ?? source.monto_120 ?? null,
        compras180: source.compras180 ?? source.compras_180 ?? null,
        compras_180: source.compras180 ?? source.compras_180 ?? null,
        monto180: source.monto180 ?? source.monto_180 ?? null,
        monto_180: source.monto180 ?? source.monto_180 ?? null,
        ticketProm180: source.ticketProm180 ?? source.ticket_prom_180 ?? null,
        ticket_prom_180: source.ticketProm180 ?? source.ticket_prom_180 ?? null,
        montoAcumulado: source.montoAcumulado ?? source.monto_acumulado ?? null,
        monto_acumulado: source.montoAcumulado ?? source.monto_acumulado ?? null,
        segmento: toText(source.segmento || source.segmento_final) || null,
        realizoCompra: source.realizoCompra ?? source.realizo_compra ?? null,
        realizo_compra: source.realizoCompra ?? source.realizo_compra ?? null,
        cadenciaPromDias: source.cadenciaPromDias ?? source.cadencia_prom_dias ?? null,
        cadencia_prom_dias: source.cadenciaPromDias ?? source.cadencia_prom_dias ?? null,
        rangoCompras: toText(source.rangoCompras || source.rango_compras) || null,
        rango_compras: toText(source.rangoCompras || source.rango_compras) || null,
