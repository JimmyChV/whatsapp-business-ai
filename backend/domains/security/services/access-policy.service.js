...
const PERMISSIONS = Object.freeze({
    ...
    TENANT_COMMERCIAL_INTELLIGENCE_MANAGE: 'tenant.commercial_intelligence.manage',
    TENANT_CUSTOMERS_READ: 'tenant.customers.read',
    TENANT_CUSTOMERS_MANAGE: 'tenant.customers.manage',
    TENANT_CATALOGS_READ: 'tenant.catalogs.read',
    ...
    TENANT_AUTOMATIONS_MANAGE: 'tenant.automations.manage',
...
const PERMISSION_LABELS = Object.freeze({
    ...
    [PERMISSIONS.TENANT_USERS_READ]: 'Ver usuarios',
    ...
    [PERMISSIONS.TENANT_COMMERCIAL_INTELLIGENCE_MANAGE]: 'Gestionar inteligencia comercial',
    [PERMISSIONS.TENANT_CUSTOMERS_READ]: 'Ver clientes',
    [PERMISSIONS.TENANT_CUSTOMERS_MANAGE]: 'Gestionar clientes',
    [PERMISSIONS.TENANT_CATALOGS_READ]: 'Ver catalogos',
    ...
    [PERMISSIONS.TENANT_AUTOMATIONS_MANAGE]: 'Gestionar automatizaciones',
...
const SYSTEM_PERMISSION_PACKS = Object.freeze({
    ...
    catalog_management: {
        ...
        permissions: [
            PERMISSIONS.TENANT_CATALOGS_READ,
            PERMISSIONS.TENANT_CATALOGS_MANAGE
        ],
        active: true
    },
    campaigns_management: {
        label: 'Gestion de campanas',
        permissions: [
    ...
    meta_templates_management: {
        label: 'Gestion de plantillas Meta',
        permissions: [
            PERMISSIONS.TENANT_META_TEMPLATES_READ,
            PERMISSIONS.TENANT_META_TEMPLATES_MANAGE
        ],
        active: true
    },
    automations_management: {
        label: 'Gestion de automatizaciones',
        permissions: [
            PERMISSIONS.TENANT_AUTOMATIONS_READ,
            PERMISSIONS.TENANT_AUTOMATIONS_MANAGE,
            PERMISSIONS.TENANT_SCHEDULES_READ,
