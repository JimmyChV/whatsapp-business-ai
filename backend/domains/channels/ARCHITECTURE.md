...
- `helpers/*`: pure utilities shared by channel services.
  ...
  - socket runtime support: `socket-session.helpers.js`, `socket-module-context.helpers.js`, `socket-agent-meta-cache.helpers.js`, `socket-order-debug.helpers.js`, `socket-runtime-bootstrap.helpers.js`
